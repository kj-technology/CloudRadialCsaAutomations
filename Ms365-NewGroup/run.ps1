...
if ($resultCode -Eq 200) {
    ...
    $GroupObject = New-MgGroup -DisplayName $GroupName -Description $GroupDescription -MailEnabled:$True -MailNickname $GroupName -SecurityEnabled:$True -GroupTypes @("Unified")
